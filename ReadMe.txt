...
Another method is to create a mask of all the clears and count the number to reduce clears that 
are created when we create new perimeterfor some super location values.  The new method does this 
and correctly counts the actual clear count.  However, it seems to create slightly worse results.
The "old" method (used in v1.2c) but it does not correctly count the number of new perimeter entries.  
In fact it seems to downgrade these entries and due to a bug that added a little extra for linked 
clears this method seems to work better than both other methods so I left it in.  The results are 
shown below.
...
GUESS PRIORITY:
When guessing and there is a tie which direction should we pick.  I chose left to right and top
...
be changes in the Test Run menu by unchecking the "Top to bottom priority".  I also tried using 
bottom to top right to left and this looked worse so I did not add an option for this.
...
Beginner 9x9x10 starting at 2,2 using 1000 solutions for brute force (BF):
Seed	Jar1.05		v1.2e jar+	tb			tb 400 BF	v1.2e old+	v1.2e new+	MOE
1		97.245%		97.220%		97.229%		97.228%		97.221%		97.218%		+-.102%
2		97.143%		97.178%		97.189%		97.190%		97.179%		97.181%
3		97.234%		97.142%		97.154%		97.152%		97.147%		97.141%
4		97.105%		97.100%		97.109%		97.110%		97.102%		97.099%
5		97.181%		97.132%		97.143%		97.145%		97.142%		97.131%
6		97.240%		97.174%		97.181%		97.178%		97.166%		97.175%
7		97.254%		97.270%		97.273%		97.272%		97.275%		97.267%
8		97.216%		97.274%		97.275%		97.276%		97.270%		97.275%
9		97.200%		97.180%		97.181%		97.178%		97.187%		97.181%
10		97.113%		97.104%		97.110%		97.109%		97.100%		97.103%
----------------------------------------------------------------------------
		97.1931%	97.1774%	97.1844%	97.1838%	97.1789%	97.1771%	+-.032
----------------------------------------------------------------------------
11		97.159%		97.138%		97.143%		97.146%		97.136%		97.138%
12		97.117%		97.170%		97.166%		97.162%		97.174%		97.168%
13		97.108%		97.141%		97.145%		97.147%		97.138%		97.140%
14		97.240%		97.256%		97.276%		97.280%		97.259%		97.257%
15		97.220%		97.232%		97.234%		97.234%		97.229%		97.232%
16		97.157%		97.178%		97.200%		97.196%		97.184%		97.179%
17		97.233%		97.208%		97.215%		97.217%		97.216%		97.208%
18		97.148%		97.126%		97.142%		97.140%		97.129%		97.124%
19		97.132%		97.109%		97.099%		97.099%		97.108%		97.109%
20		97.177%		97.176%		97.179%		97.175%		97.183%		97.177%
----------------------------------------------------------------------------
		97.1691%	97.1734%	97.1799%	97.1796%	97.1756%	97.1732%	+-.023%
----------------------------------------------------------------------------
...
----------------------------------------------------------------------------
Avg		97.1876%	97.1826%	97.1863%	97.1858%	97.1834%	97.1752%
				

Intermediate 16x16x40 starting 2,2 using 1000 solutions for brute force (BF):
Seed	jar1.05		v1.2e jar+	tb			tb 400 BF	v1.2e old+	MOE
1		89.177%		89.194%		89.216%		89.216%		89.188%		+-.194%
2		89.291%		89.365%		89.397%		89.377%		89.368%
3		89.224%		89.231%		89.218%		89.202%		89.250%
4		89.110%		89.117%		89.147%		89.138%		89.109%
5		89.215%		89.212%		89.211%		89.209%		89.218%
6		89.116%		89.127%		89.130%		89.126%		89.110%
7		89.234%		89.233%		89.244%		89.242%		89.235%
8		88.958%		88.985%		89.004%		88.999%		88.982%
9		89.104%		89.170%		89.180%		89.171%		89.175%
10		89.329%		89.372%		89.377%		89.379%		89.374%
----------------------------------------------------------------
		89.1758%	89.2006%	89.2124%	89.2059%	89.2009%	+-.061%
----------------------------------------------------------------
11		89.218%		89.182%		89.198%		89.194%		89.184%			
12		89.231%		89.214%		89.225%		89.214%		89.212%			
13		89.240%		89.227%		89.259%		89.254%		89.221%
14		89.127%		89.121%		89.161%		89.157%		89.111%			
15		89.100%		89.175%		89.210%		89.201%		89.187%			
16		89.261%		89.316%		89.334%		89.334%		89.317%
17		89.206%		89.213%		89.217%		89.222%		89.216%
18		89.172%		89.143%		89.157%		89.150%		89.156%
19		89.311%		89.338%		89.372%		89.359%		89.345%
20		89.293%		89.252%		89.242%		89.227%		89.258%
----------------------------------------------------------------
		89.2159%	89.2181%	89.2375%	89.2312%	89.2207%	+-.043%
----------------------------------------------------------------
...
36		89.146%		89.161%		89.183%		89.
37		89.171%		89.085%		89.069%		89.
38		89.115%		89.101%		89.109%		89.
39		89.198%		89.180%		89.160%		89.
40		89.033%		89.135%		89.118%		89.
----------------------------------------------------------------
		89.1534%	89.1683%	89.1657%	89.						+-.031%
----------------------------------------------------------------
Avg		89.1745%	89.1956%	89.2028%	89.%	89.2108%


Expert 30x16x99 starting at 3,3 using 1000 solutions for brute force:
Seed	Jar1.05		v1.2e jar+	tb			400 BF		2000 BF		v1.2e new+	v1.2e old+	MOE		
1		53.837%		54.108%		54.081%		54.066%		54.145%		54.097%		54.125%		+-.309%	
2		53.887%		54.049%		54.029%		53.984%		54.082%		54.038%		54.063%
3		53.897%		53.908%		53.886%		53.846%		53.960%		53.894%		53.888%
4		53.890%		53.925%		53.887%		53.882%		53.924%		53.925%		53.939%
5		53.745%		53.871%		53.867%		53.835%		53.899%		53.872%		53.874%
6		53.935%		54.148%		54.150%		54.073%		54.202%		54.144%		54.144%
7		53.906%		54.166%		54.142%		54.099%		54.176%		54.175%		54.181%
8		54.059%		54.053%		54.078%		54.029%		54.103%		54.049%		54.053%
9		54.182%		54.174%		54.152%		54.113%		54.197%		54.170%		54.153%
10		53.890%		53.922%		53.890%		53.852%		53.928%		53.921%		53.937%
---------------------------------------------------------------------------------------
		53.9228%	54.0324%	54.0162%	53.9779%	54.0616%	54.0285%	54.0357%	+-.098% 
---------------------------------------------------------------------------------------
11		54.055%		54.017%		54.005%		53.979%					54.012%		54.028%
12		54.099%		54.124%		54.140%		54.075%					54.109%		54.137%
13		54.187%		54.114%		54.117%		54.050%					54.109%		54.125%
14		54.086%		54.255%		54.252%		54.205%					54.259%		54.229%
15		53.592%		53.797%		53.785%		53.740%					53.799%		53.793%
16		53.860%		53.934%		53.972%		53.867%					53.926%		53.927%
17		54.012%		54.051%		54.080%		53.983%					54.048%		54.054%
18		53.808%		54.127%		54.059%		54.039%					54.116%		54.149%
19		53.875%		53.823%		53.848%		53.802%					53.814%		53.826%
20		53.739%		53.915%		53.902%		53.854%					53.913%		53.899%
---------------------------------------------------------------------------------------
		53.9313%	54.0157%	54.0160%	53.9594%				54.0105%	54.0167%	+-.069% 
---------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------
Avg		53.8823%	53.9680%	53.9623%	53.9124%				53.9629%	54.0262%
